...
FOOD_LIBRARY: dict[str, dict] = {
    ...
    "mackerel": _entry("青花鱼 / 鲐鱼", "Mackerel", "protein", 205, 19, 0, 13.9,
        validation=["lean_protein", "vitamin_d"], execution=["deep_sea_fish"],
    ...
    # Domestic, practical fat-loss additions.
    "onion": _entry("洋葱", "Onion", "veg", 40, 1.1, 9.3, 0.1,
        fiber=1.7,
        execution=["cruciferous_fungi_algae"],
        roles=[], tags=["veg", "aromatic"],
        max_practical_serving_g=200,
        nutrients={"calcium_mg": 23, "iron_mg": 0.2, "zinc_mg": 0.2,
                   "selenium_mcg": 0.5, "folate_mcg": 19,
                   "fiber_g": 1.7, "vitamin_e_mg": 0.02,
                   "vitamin_k_mcg": 0.4}),

    "green_pepper": _entry("青椒", "Green pepper", "veg", 22, 1.0, 5.0, 0.2,
        fiber=1.7,
        execution=["cruciferous_fungi_algae"],
        roles=[], tags=["veg"],
        max_practical_serving_g=200,
        nutrients={"calcium_mg": 10, "iron_mg": 0.3, "zinc_mg": 0.2,
                   "selenium_mcg": 0.1, "vitamin_a_mcg": 18,
                   "folate_mcg": 10, "fiber_g": 1.7,
                   "vitamin_e_mg": 0.4, "vitamin_k_mcg": 7.4}),

    "bell_pepper": _entry("彩椒", "Bell pepper", "veg", 31, 1.0, 6.0, 0.3,
        fiber=2.1,
        execution=["cruciferous_fungi_algae"],
        roles=["vitamin_a", "folate"], tags=["veg"],
        max_practical_serving_g=200,
        nutrients={"calcium_mg": 7, "iron_mg": 0.4, "zinc_mg": 0.3,
                   "selenium_mcg": 0.1, "vitamin_a_mcg": 157,
                   "folate_mcg": 46, "fiber_g": 2.1,
                   "vitamin_e_mg": 1.6, "vitamin_k_mcg": 4.9}),

    "you_cai": _entry("油菜", "Yu choy", "veg", 18, 1.8, 3.8, 0.2,
        fiber=1.1,
        validation=["dark_green_cruciferous", "calcium"],
        execution=["dark_leafy_green"],
        roles=["calcium", "folate", "vitamin_k"], tags=["leafy_green"],
        max_practical_serving_g=250,
        nutrients={"calcium_mg": 108, "iron_mg": 1.2, "zinc_mg": 0.4,
                   "selenium_mcg": 0.8, "vitamin_a_mcg": 180,
                   "folate_mcg": 80, "fiber_g": 1.1,
                   "vitamin_e_mg": 0.9, "vitamin_k_mcg": 150}),

    "baby_napa_cabbage": _entry("娃娃菜", "Baby napa cabbage", "veg", 13, 1.2, 2.4, 0.2,
        fiber=1.0,
        execution=["cruciferous_fungi_algae"],
        roles=[], tags=["veg", "cruciferous"],
        max_practical_serving_g=300,
        nutrients={"calcium_mg": 35, "iron_mg": 0.6, "zinc_mg": 0.2,
                   "selenium_mcg": 0.5, "vitamin_a_mcg": 22,
                   "folate_mcg": 30, "fiber_g": 1.0,
                   "vitamin_k_mcg": 38}),

    "konjac": _entry("魔芋", "Konjac", "veg", 7, 0.1, 3.3, 0.0,
        fiber=2.7,
        execution=["cruciferous_fungi_algae"],
        roles=["fiber"], tags=["veg", "functional"],
        max_practical_serving_g=300,
        nutrients={"calcium_mg": 43, "iron_mg": 0.4, "zinc_mg": 0.1,
                   "selenium_mcg": 0.3, "folate_mcg": 2,
                   "fiber_g": 2.7}),

    "celtuce": _entry("莴笋", "Celtuce", "veg", 14, 1.0, 2.8, 0.2,
        fiber=1.2,
        execution=["cruciferous_fungi_algae"],
        roles=[], tags=["veg"],
        max_practical_serving_g=250,
        nutrients={"calcium_mg": 23, "iron_mg": 0.9, "zinc_mg": 0.3,
                   "selenium_mcg": 0.4, "vitamin_a_mcg": 25,
                   "folate_mcg": 21, "fiber_g": 1.2,
                   "vitamin_k_mcg": 29}),

    "zucchini": _entry("西葫芦", "Zucchini", "veg", 17, 1.2, 3.1, 0.3,
        fiber=1.0,
        execution=["cruciferous_fungi_algae"],
        roles=[], tags=["veg"],
        max_practical_serving_g=250,
        nutrients={"calcium_mg": 16, "iron_mg": 0.4, "zinc_mg": 0.3,
                   "selenium_mcg": 0.2, "vitamin_a_mcg": 10,
                   "folate_mcg": 24, "fiber_g": 1.0,
                   "vitamin_e_mg": 0.1, "vitamin_k_mcg": 4.3}),

    "basa_fish": _entry("巴沙鱼 / 龙利鱼", "Basa fish", "protein", 90, 15, 0, 3,
        validation=["lean_protein"], execution=["lean_white_meat"],
        roles=[], tags=["fish"],
        max_practical_serving_g=220,
        nutrients={"calcium_mg": 8, "iron_mg": 0.3, "zinc_mg": 0.4,
                   "selenium_mcg": 12, "b12_mcg": 0.7,
                   "vitamin_d_mcg": 0.5, "omega3_g": 0.2}),

    "dried_shrimp": _entry("虾皮", "Dried shrimp", "protein", 153, 30.7, 2.5, 2.2,
        validation=["calcium", "red_meat_shellfish"], execution=["shellfish"],
        roles=["calcium", "selenium"], tags=["shellfish", "condiment"],
        notes="High sodium; use as a small seasoning or soup booster.",
        max_practical_serving_g=15,
        nutrients={"calcium_mg": 991, "iron_mg": 6.7, "zinc_mg": 1.9,
                   "iodine_mcg": 260, "selenium_mcg": 75,
                   "b12_mcg": 1.2, "folate_mcg": 8,
                   "vitamin_e_mg": 1.0}),

    "sesame_paste": _entry("芝麻酱", "Sesame paste", "fat", 630, 19, 16, 54,
        fiber=6.0,
        validation=["calcium", "vitamin_e_healthy_fat"],
        execution=["nut_seed_functional"],
        roles=["calcium", "zinc"], tags=["nut_seed", "condiment"],
        notes="Very calcium-dense but calorie-dense; weigh portions.",
        max_practical_serving_g=20,
        nutrients={"calcium_mg": 1170, "iron_mg": 9.0, "zinc_mg": 7.3,
                   "selenium_mcg": 34, "folate_mcg": 98,
                   "fiber_g": 6.0, "vitamin_e_mg": 2.6}),

    "black_beans": _entry("黑豆（熟）", "Black soybeans (cooked)", "protein", 173, 16, 10, 9,
        fiber=6.5,
        validation=["lean_protein"], execution=["soy_product"],
        roles=["fiber", "iron_tier2", "folate"], tags=["soy", "legume"],
        max_practical_serving_g=150,
        nutrients={"calcium_mg": 68, "iron_mg": 2.5, "zinc_mg": 1.1,
                   "selenium_mcg": 2.0, "folate_mcg": 85,
                   "fiber_g": 6.5, "vitamin_k_mcg": 6}),

    "red_beans": _entry("红豆（熟）", "Adzuki beans (cooked)", "carb", 128, 7.5, 25, 0.1,
        fiber=7.3,
        validation=["staple"], execution=["slow_carb_staple"],
        roles=["fiber", "folate", "iron_tier2"], tags=["legume", "staple"],
        max_practical_serving_g=200,
        nutrients={"calcium_mg": 28, "iron_mg": 2.0, "zinc_mg": 1.1,
                   "selenium_mcg": 1.2, "folate_mcg": 120,
                   "fiber_g": 7.3, "vitamin_k_mcg": 2}),

    "mung_beans": _entry("绿豆（熟）", "Mung beans (cooked)", "carb", 105, 7.0, 19, 0.4,
        fiber=7.6,
        validation=["staple"], execution=["slow_carb_staple"],
        roles=["fiber", "folate"], tags=["legume", "staple"],
        max_practical_serving_g=200,
        nutrients={"calcium_mg": 27, "iron_mg": 1.4, "zinc_mg": 0.8,
                   "selenium_mcg": 2.5, "folate_mcg": 159,
                   "fiber_g": 7.6, "vitamin_k_mcg": 2.7}),
